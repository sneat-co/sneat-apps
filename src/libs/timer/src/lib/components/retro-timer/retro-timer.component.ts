...
import { IRetrospectiveRequest, RetrospectiveService } from '@sneat/scrumspace/retrospectives';
...
export class RetroTimerComponent implements OnDestroy, OnChanges {
  ...
  private onTimerTicked = (timer: ITimerState): void => {
    ...
    try {
      ...
      //   },
      // };
      this.totalElapsed = timer?.elapsedSeconds && secondsToStr(timer.elapsedSeconds) || '0';
