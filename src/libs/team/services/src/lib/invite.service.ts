...
export class InviteService {
	...
	public acceptInviteByAuthenticatedUser(inviteInfo: IJoinTeamInfoResponse): Observable<IAcceptInviteResponse> {
	...
	public acceptInviteByUnauthenticatedUser(inviteInfo: IJoinTeamInfoResponse): Observable<IAcceptInviteResponse> {
		if (inviteInfo.invite.to.channel === 'email' && inviteInfo.invite.to.address) {
	...
	private acceptEmailInviteByUnauthenticatedUser(inviteInfo: IJoinTeamInfoResponse): Observable<IAcceptInviteResponse> {
