...
const testSetupFiles = [
  ...
  'libs/extensions/calendarius/core/src/test-setup.ts',
  'libs/extensions/calendarius/shared/src/test-setup.ts',
  'libs/extensions/calendarius/main/src/test-setup.ts',
