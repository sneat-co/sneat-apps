...
| ---- | ---------------------------------- | --------- | ----- | ---------- |
| 1    | libs/extensions/calendarius/shared | 1416      | 2180  | 35.05%     |
...
| ---------------------- | ------- | ------ | ------- | ------------------ | ------------------------------------------------------------------ |
| ext-calendarius-shared | 35.05%  | 60%    | -24.95% | 🟡 In Progress     | [Report](../libs/extensions/calendarius/shared/COVERAGE-REPORT.md) |
...
pnpm nx run-many --target=test --projects=ext-calendarius-shared,contactus-shared

# Run with coverage
pnpm nx run-many --target=test --projects=ext-calendarius-shared,contactus-shared --coverage
```
