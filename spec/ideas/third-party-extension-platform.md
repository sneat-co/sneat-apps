...
**Date:** 2026-06-17
**Owner:** alex
**Promotes To:** extension-consent-and-scopes, extension-host-and-bridge, extension-permission-management-ui, protected-data-gateway, trusted-first-party-extensions
**Supersedes:** —
...
- **Pass the user's Firebase ID token to _every_ extension (uniform trusted mode).** A Firebase ID token is a bearer JWT and is not origin-bound, so this works technically. Rejected for untrusted third parties: it grants full Firestore access, bypassing consent and scopes. Adopted _only_ for the allowlisted first-party trusted class, where it matches existing trust.
