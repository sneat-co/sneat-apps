...
export interface IIdAndOptionalBriefAndOptionalDto<Brief, Dto> {
	readonly id: string;
	readonly brief?: Brief | null;
	readonly dto?: Dto | null;
}

export interface IIdAndBriefAndOptionalDto<Brief, Dto> {
	readonly id: string;
	readonly brief: Brief;
	readonly dto?: Dto | null;
}

export interface IIdAndBriefAndDto<Brief, Dto> {
	readonly id: string;
	readonly brief: Brief;
	readonly dto: Dto;
}
