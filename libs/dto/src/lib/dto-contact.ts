...
export const emptyContactBase: IContactBase = { type: '' as ContactType, name: {} };
...
export interface IRelatedPerson extends IPerson { // relatedAs to current user or a specific contact
