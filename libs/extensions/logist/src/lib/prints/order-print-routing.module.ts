  ...
  imports: [
    RouterModule.forChild([
      ...
      },
      {
        path: 'expedition-doc',
        loadComponent: () =>
          import('./order-expedition-print-doc/order-expedition-print-doc.component').then(
            (m) => m.OrderExpeditionPrintDocComponent,
          ),
      },
      {
        path: 'trucker-summary',
        loadComponent: () =>
          import('./order-trucker-summary/order-trucker-summary.component').then(
            (m) => m.OrderTruckerSummaryComponent,
          ),
      },
    ]),
  ],
