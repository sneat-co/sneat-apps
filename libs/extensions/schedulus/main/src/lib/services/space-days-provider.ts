...
export class SpaceDaysProvider {
	...
	private readonly recurringsTeamItemService: ModuleSpaceItemService<
		IHappeningBrief,
		IHappeningDbo
	>;
	...
	constructor(
		...
		// super();
		this.recurringsTeamItemService = new ModuleSpaceItemService(
			'calendarium',
	...
	public getTeamDay(date: Date): SpaceDay {
