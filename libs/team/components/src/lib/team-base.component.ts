...
export abstract class TeamBaseComponent extends SneatBaseComponent {
  ...
  protected constructor(
    ...
    try {
      ...
      this.teamParams.errorLogger.logError(e, `Failed in (${this.className}).constructor()`);
      throw e;
    }
  }
  ...
  protected onTeamIdChanged(): void {
    console.log(`${this.className}.onTeamIdChanged()`, this.className, this.team?.id);
  }

  protected onTeamDtoChanged(): void {
    console.log(`${this.className}.onTeamDtoChanged()`, this.className, this.team?.dto);
  }
  ...
  private setNewTeamContext(teamContext?: ITeamContext): void {
    console.log(`${this.className}.setNewTeamContext(id=${teamContext?.id}), previous id=${this.teamContext?.id}`, teamContext);
  ...
  private readonly onTeamContextChanged = (team: ITeamContext): void => {
    ...
    console.log(`${this.className}.onTeamContextChanged() => dtoChanged=${dtoChanged}, team:`, team);
