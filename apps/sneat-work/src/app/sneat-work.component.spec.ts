...
import { SneatWorkComponent } from './sneat-work.component';

describe('AppComponent', () => {
  beforeEach(waitForAsync(async () => {
    await TestBed.configureTestingModule({
      imports: [SneatWorkComponent],
      ...
      .overrideComponent(SneatWorkComponent, {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(SneatWorkComponent);
