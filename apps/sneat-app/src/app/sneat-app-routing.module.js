...
const routes = [
    ...
    // },
    {
        path: '',
        pathMatch: 'full',
        loadComponent: () => import('./pages/sneat-app-home-page/sneat-app-home-page.component').then((m) => m.SneatAppHomePageComponent),
    },
    {
        path: 'telegram-menu',
        pathMatch: 'full',
        loadChildren: () => import('./pages/telegram-menu/telegram-menu-page.module').then((m) => m.TelegramMenuPageModule),
    },
    {
        path: 'my',
    ...
    },
    {
        ...
        loadChildren: () => import('@sneat/team-pages').then((m) => m.TeamSpaceRoutingModule),
    },
    {
        path: 'join/:teamType',
        loadComponent: () => import('@sneat/team-pages').then((m) => m.JoinTeamPageComponent),
    },
    // {
    ...
    {
        path: 'communes',
        loadChildren: () => import('@sneat/communes-ui').then((m) => m.CommunesRoutingModule),
    },
    {
        path: 'signed-out',
        redirectTo: 'login',
...
let SneatAppRoutingModule = class SneatAppRoutingModule {
};
SneatAppRoutingModule = __decorate([
    NgModule({
        imports: [
...
export { SneatAppRoutingModule };
//# sourceMappingURL=sneat-app-routing.module.js.map