...
const angularFireProviders = getAngularFireProviders(environment.firebaseConfig);
console.log('firebaseModules', angularFireProviders);
const contactRolesByType = {
    company: [
...
let LogistAppModule = class LogistAppModule {
};
LogistAppModule = __decorate([
    NgModule({
        imports: [
...
export { LogistAppModule };
//# sourceMappingURL=logist-app.module.js.map